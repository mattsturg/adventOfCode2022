class Rope:
    ...
    def move_tail(self):
        ...
        if self.head_location[0] in range(self.tail_location[0]-1, self.tail_location[0]+2) and self.head_location[1] in range(self.tail_location[1]-1, self.tail_location[1]+2):
            return
        else:
            # not adjacent
